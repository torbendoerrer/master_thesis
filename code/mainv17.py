...
from utilsv17 import extract_json_from_output, create_excel_dashboard, extract_known_canon, heavy_preprocessing, create_heuristic_table_plan
from agentsv17 import global_joiner, synthesizer, avc_validator

def process_lovc_json(full_model_file, test_slice_file, output_file, debug_file="debug_preprocessedv17.json"):
    ...
    try:
        with open("debug_1_local_plansv17.json", "w", encoding="utf-8") as f:
    ...
    try:
        with open("debug_2_clustersv17.json", "w", encoding="utf-8") as f:
    ...
    try:
        with open("debug_3_final_datav17.json", "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    OUTPUT_EXCEL = "MAS_Entwickler_Dashboard_Finalv17.xlsx"
