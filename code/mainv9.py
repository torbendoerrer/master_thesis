...
from utilsv9 import extract_json_from_output, create_excel_dashboard, extract_known_canon, preprocess_characteristic_json
from agentsv9 import analyst, architect, synthesizer
...
def process_lovc_json(input_file, output_file):
    ...
    for cls in classes:
        for char in cls.get("characteristics", []):
            ...
            # 2. Schritt: Python Pre-Processor markiert deterministisch unklassifizierte Geistermerkmale
            processed_char = preprocess_characteristic_json(char, known_canon)
            chunk_json_str = json.dumps(processed_char, indent=2)
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "MAS_Entwickler_Dashboardv9.xlsx"
