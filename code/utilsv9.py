...
def extract_known_canon(data):
    ...
    # --- MOCK-DATEN FÜR DEN TESTLAUF ---
    # Da das Test-JSON nicht das ganze Modell enthält, fügen wir die fehlenden, 
    # legitimen Merkmale manuell hinzu, damit sie nicht fälschlicherweise gelöscht werden:
    mock_chars = [
        "K40_FG_AF", "K40_ABL", "K40_TS", "K40_BRM", "K40_PL", "K40_FST", 
        "K40_5R", "K40_ROD", "T32_BRM", "K40_KO_AF", "K40_DSB", "K40_SCHP", 
        "K40_KO", "GRI_ART", "KK", "VO", "VL", "MOD", "GP", "UG_VI_ELX", 
        "BS", "T24_GR", "LIGHT", "R_PS", "SP_PS", "GM_R", "GM_QUICKS", 
        "GM_CC", "GM_LIGHT", "GM_D22", "DR", "GM_DR", "KID_PS", "M200_PS", 
        "M300_PS", "M400_PS", "M350_PS", "M500_PS", "T25_PS", "T25_BRM_PS", 
        "T26_PS", "T40_PS", "T50_PS", "SEDO_PS"
    ]
    for c in mock_chars:
        known_canon.add(c.upper())
