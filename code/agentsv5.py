...
analyst = Agent(
    ...
    5. GANZ WICHTIG: Wenn eine Bedingung/Syntax leer ist (oder fehlt), bedeutet das in SAP "NOT SPECIFIED". Interpretiere ein leeres Feld NIEMALS als den String-Wert '0'! Schreibe für solche Fälle explizit das Konzept "NOT SPECIFIED" in deine Liste.''',
    verbose=True,
