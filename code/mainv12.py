...
from utilsv12 import extract_json_from_output, create_excel_dashboard, extract_known_canon, heavy_preprocessing
from agentsv12 import local_builder, global_joiner, synthesizer
...
def process_lovc_json(full_model_file, test_slice_file, output_file, debug_file="debug_preprocessed.json"):
    ...
    try:
        ...
        print(f"💾 [TRACE 1] Lokale Baupläne gespeichert unter: debug_1_local_plans.json")
    except Exception as e:
        pass
    ...
    try:
        ...
        print(f"💾 [TRACE 2] Cluster-Buckets gespeichert unter: debug_2_clusters.json")
    except Exception as e:
        pass
    ...
    try:
        ...
        print(f"💾 [TRACE 3] Synthese-Ergebnis gespeichert unter: debug_3_final_data.json")
    except Exception as e:
        pass
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "MAS_Entwickler_Dashboardv12.xlsx"
