...
from utilsv7 import extract_json_from_output, create_excel_dashboard
from agentsv7 import analyst, architect, synthesizer
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "MAS_Entwickler_Dashboardv7.xlsx"
