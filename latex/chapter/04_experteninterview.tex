...
\begin{figure}[htbp]
    ...
    \caption{Zeitaufwand bei der direkten Migration von LO-VC zu AVC (Schätzwert nach Experteninterview).}
    \label{fig:pie_time}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{} 
        ...
        \textbf{Einhaltung von AVC-Modellierungsrichtlinien:} \newline
        Generierung von standardkonformem Code unter direkter Berücksichtigung von Performance-Best-Practices. \\
        
        \bottomrule
    \end{tabularx}
    \caption{Requirement Traceability Matrix: Ableitung der funktionalen und architektonischen Systemanforderungen (Kap. 4.3) aus den empirisch identifizierten Praxis-Hürden (Kap. 4.2).}
\end{table}
