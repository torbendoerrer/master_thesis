...
Zur Definition der Baseline muss laut dem Experten zwischen zwei Migrationsansätzen unterschieden werden: Bei einem Greenfield-Ansatz (kompletter Neuaufbau) verteilt sich der Aufwand auf etwa 20 \% für die Merkmalswelt, 40 \% für die Analyse und 40 \% für die Umsetzung. Da dieser Ansatz informationstechnisch jedoch nicht automatisiert abgebildet werden kann, fokussiert sich der Prototyp auf die direkte Migration. Bei dieser direkten Transformation bildet die Umwandlung der Vorbedingungen in Constraints den absoluten Flaschenhals, der laut Experte etwa zwei Drittel (66 \%) der Gesamtarbeitszeit verschlingt. Diese 66 \% bilden somit die relevante Baseline für die Evaluierung des MAS.
